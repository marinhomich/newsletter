        ...
        <main className="flex px-6 drop-shadow-2xl">
            <section className="bg-azul-escuro hidden lg:block w-1/2 rounded-l-lg">
                <img
                    ...
                    src="/assets/icone-mergulhador.svg"
                    alt="icone de mergulhador"
                />
            </section>

            <section
                className="bg-white p-10 gap-6 flex flex-col rounded-lg lg:w-1/2 justify-center lg:rounded-l-none"
            >
                ...
                <div className="text-center">
                    <h1 className="text-4xl mb-2">Newsletter</h1>
                ...
                <form>
                    ...
                    />
                    <button
                        className="font-bold text-white bg-azul-escuro w-full py-2 rounded-full shadow-md hover:bg-azul-hover duration-150"
                        type="button"
                    >
                        Inscreva-se
                    </button>
